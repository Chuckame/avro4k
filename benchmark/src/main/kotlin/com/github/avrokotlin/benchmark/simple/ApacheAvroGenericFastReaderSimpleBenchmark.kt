...
/**
 * Apache's **generic** read path on the `simple` workload, with its fast reader on and off.
 ...
 * `ReflectData` rows.
 */
internal class ApacheAvroGenericFastReaderSimpleBenchmark : SerializationSimpleBenchmark() {
    @Param("false", "true")
    @JvmField
